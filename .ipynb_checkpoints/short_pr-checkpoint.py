...
# # Short photoreceptor subtypes in Megaphragma
# - Central pair, R2R5, contribute the largest to the volume of the fused rhabdom
# - 
...
# +
tp = ''
data_path = f'~/Data/200131_lamina/{tp}_linkdf.pickle'
