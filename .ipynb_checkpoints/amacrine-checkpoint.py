...
# # Amacrine
# - The outputs made by amacrine are the main variables that cluster ommatidia into dorsal, central, and ventral regions
# - Inputs to amacrine are relatively uniform across ommatidia
...
am_inputs = pd.DataFrame(data={o: adj_mats[o]['centri'] for o in ommatidia}).astype(int)
...
ret_hues = {'ventral': 'maroon',
           'dorsal': 'darkmagenta',
           'central': 'steelblue'}
cx_order = ['centri->R7', 'centri->R7p', 'centri->LMC_1', 'centri->LMC_2', 'centri->LMC_3', 'centri->R2R5']
